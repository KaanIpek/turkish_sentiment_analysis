...
public class LanguageIdentifier {
  ...
  LanguageIdentifier(Map<String, CharNgramLanguageModel> models) {
    this.models = models;
  ...
  public String identify(String input) {
    ...
    return identifySamples(clean, getStepping(clean, clean.length() ));
  }
  ...
  // The function I need to make a server from.
